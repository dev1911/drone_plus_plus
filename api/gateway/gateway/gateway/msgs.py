...
# logistic_service_host = os.getenv("LOGISTICS_SERVICE_SERVICE_HOST" , "127.0.0.1")
...
# logistic_service_port = os.getenv("LOGISTICS_SERVICE_SERVICE_PORT" , "9000")
# order_service_port = os.getenv("ORDER_SERVICE_SERVICE_PORT" , "9000")

# user_service = "http://" + user_service_host + ":" + user_service_port + "/"
# logistic_service = "http://" + logistic_service_host + ":" + logistic_service_port + "/"
# order_service = "http://" + order_service_host + ":" + order_service_port + "/"
